...
csv_directory <- "/Users/suzettepalmer/Desktop/IntegratedLearner_Dec2024/Wang_performance_csv"
# Load in CSV files
...
filtered_df <- metadata %>%
  filter(str_starts(File_Name, "wang")) %>%
  mutate(
...
continuous_var <- c("age", "bmi", "creatinine", "egfr", "urea")
binary_var <- c("gender", "studygroup")
...
PATH <- "/Users/suzettepalmer/Desktop/IntegratedLearner_Dec2024/wang_performance_csv/results"

write.csv(unfiltered_training_aucroc, file.path(PATH, "wang_unfiltered_training_aucroc_12152024.csv"), row.names = FALSE)
write.csv(filtered_training_aucroc, file.path(PATH,"wang_filtered_training_aucroc_12152024.csv"), row.names = FALSE)
write.csv(unfiltered_testing_aucroc, file.path(PATH,"wang_unfiltered_testing_aucroc_12152024.csv"), row.names = FALSE)
write.csv(filtered_testing_aucroc, file.path(PATH,"wang_filtered_testing_aucroc_12152024.csv"), row.names = FALSE)

write.csv(unfiltered_training_rmse, file.path(PATH,"wang_unfiltered_training_rmse_12152024.csv"), row.names = FALSE)
write.csv(filtered_training_rmse, file.path(PATH,"wang_filtered_training_rmse_12152024.csv"), row.names = FALSE)
write.csv(unfiltered_testing_rmse, file.path(PATH,"wang_unfiltered_testing_rmse_12152024.csv"), row.names = FALSE)
write.csv(filtered_testing_rmse, file.path(PATH,"wang_filtered_testing_rmse_12152024.csv"), row.names = FALSE)
...
output_directory = "/Users/suzettepalmer/Desktop/IntegratedLearner_Dec2024/Wang_performance_csv"
