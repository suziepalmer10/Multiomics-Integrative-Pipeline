...
csv_directory <- "/Users/suzettepalmer/Desktop/IntegratedLearner_Dec2024/Erawijantari_performance_csv"
# Load in CSV files
...
# Process files starting with "era"
filtered_df <- metadata %>%
  filter(str_starts(File_Name, "era")) %>%
  mutate(
    Study_Name = str_split_fixed(File_Name, "_", 3)[, 1],
    Response_Variable = str_split_fixed(File_Name, "_", 3)[, 2],
    Model = str_replace(str_split_fixed(File_Name, "_", 3)[, 3], ".csv", "")
  )
...
unfiltered_df <- metadata %>%
  ...
  mutate(
    Study_Name = str_split_fixed(File_Name, "_", 4)[, 2],
    Response_Variable = str_split_fixed(File_Name, "_", 4)[, 3],
...
continuous_var <- c("age", "cholesterol", "glucose")
binary_var <- c("gender", "sg", "alcohol")
...
#export to csv
write.csv(unfiltered_training_aucroc, "results/era_unfiltered_training_aucroc_12152024.csv", row.names = FALSE)
write.csv(filtered_training_aucroc, "results/era_filtered_training_aucroc_12152024.csv", row.names = FALSE)
write.csv(unfiltered_testing_aucroc, "results/era_unfiltered_testing_aucroc_12152024.csv", row.names = FALSE)
write.csv(filtered_testing_aucroc, "results/era_filtered_testing_aucroc_12152024.csv", row.names = FALSE)

write.csv(unfiltered_training_rmse, "results/era_unfiltered_training_rmse_12152024.csv", row.names = FALSE)
write.csv(filtered_training_rmse, "results/era_filtered_training_rmse_12152024.csv", row.names = FALSE)
write.csv(unfiltered_testing_rmse, "results/era_unfiltered_testing_rmse_12152024.csv", row.names = FALSE)
write.csv(filtered_testing_rmse, "results/era_filtered_testing_rmse_12152024.csv", row.names = FALSE)
...
output_directory = "/Users/suzettepalmer/Desktop/IntegratedLearner_Dec2024/Erawijantari_performance_csv"
